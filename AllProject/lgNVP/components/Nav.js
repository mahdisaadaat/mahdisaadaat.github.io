  ...
  return `
    <div class="row navbar">
        ...
        <div class="navButtons">
            ...
            <button type="button" class="btn btn-outline-success"><a class="btn-outline-success" href="https://mahdisaadaat.github.io/AllProject/lgNVP/pages/addMovie.html">Add Movie</a></button>
        </div>
    </div>`;
};
